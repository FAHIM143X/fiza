...
let handler = async (m, { conn }) => {
    ...
    try {
        ...
        await conn.sendMessage(m.chat, { image: { url }, caption: `🌈 *RAINBOW!*` }, { quoted: m })
    } catch { m.reply('❌ Failed!') }
}
handler.help = ['rainbow']; handler.tags = ['maker']; handler.command = /^(rainbow)$/i
